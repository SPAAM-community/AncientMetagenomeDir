...
4. (Once passed) comment on this PR `@spaam-bot please autofill <table_name> <project_id>` to get a half-filled template! The options for `table_name` are: `ancientmetagenome-environmental`, `ancientmetagenome-hostassociated`, and `ancientsinglegenome-hostassociated`. May take a minute or so to get the comment with the file)
...
8. Only for ancientsinglegenome-hostassociated and ancientmetagenome-hostassociated: fill the dates table
9. Request review!
...
- [ ] **Once sample table validation completed** Library metadata has been added
  - Use `@spaam-bot please autofill <table_name> <project_id>` to get a half-filled template! The options for `table_name` are: `ancientmetagenome-environmental`, `ancientmetagenome-hostassociated`, and `ancientsinglegenome-hostassociated`. May take a minute or so to get the comment with the file
...
- [ ] For ancientsinglegenome-hostassociated and ancientmetagenome-hostassociated: fill the dates table!
