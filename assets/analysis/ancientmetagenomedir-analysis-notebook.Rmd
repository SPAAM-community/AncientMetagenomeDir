...
raw_hostmetagenome <- load_thedir_data("https://raw.githubusercontent.com/SPAAM-community/AncientMetagenomeDir/v20.09.1/ancientmetagenome-hostassociated/ancientmetagenome-hostassociated.tsv", "Host Associated Metagenome") 
raw_hostsinglegenome <- load_thedir_data("https://raw.githubusercontent.com/SPAAM-community/AncientMetagenomeDir/v20.09.1/ancientsinglegenome-hostassociated/ancientsinglegenome-hostassociated.tsv", "Host Associated Single Genome") 
raw_environmental <- load_thedir_data("https://raw.githubusercontent.com/SPAAM-community/AncientMetagenomeDir/v20.09.1/ancientmetagenome-environmental/ancientmetagenome-environmental.tsv", "Environmental Metagenome") 
...
figure_age_timeline <- ggplot() +
  ...
  theme_classic() +
  scale_fill_manual(values = dir_colours, guide = guide_legend(ncol = 1, title = "")) +
  ylab("Samples (n)") +
  xlab("Years before present")  +
  labs(fill = NULL) +
  theme(legend.position = "bottom") +
