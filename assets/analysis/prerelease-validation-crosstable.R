...
cat("EXCEPTIONS ALLOWED:\n")
cat("-(ancientmetagenome-hostassociated): Klapper2023 [reseq. of FellowsYates2023 - no new samples]\n")
cat("-(ancientsinglegenome-hostassociated): Clavel2023 [Reseq of previous human study not in AMDir, different PRJ code]; Lhote2024 [sequencing data uploaded to two PRJ codes]")
cat("\n")
